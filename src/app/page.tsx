...
export default function Home() {
  return (
    <div className="h-full bg-transparent">
      ...
      <div className="fixed flex bottom-0 bg-transparent w-full h-12 z-10  p-2">
