...
export default function Home() {
  let fadeon = setTimeout(() => {
    gsap.from("#pretext", { opacity: 1 });
    gsap.to("#pretext", { duration: 1, opacity: 0 });
  ...
  return (
    <div className="h-full bg-transparent ">
      <div
        id="reload"
        className="fixed flex top-0 bg-transparent backdrop-blur-sm w-full h-20 z-10 hidden"
      >
      ...
      <div className="fixed flex top-0 bg-transparent backdrop-blur-sm w-full h-20 z-10">
        <div
          id="logosvg"
          className="items-center justify-center p-2 flex w-full h-full mt-[18rem] scale-[200%]"
        >
          <a href="">
            <svg
              className="fill-white"
      ...
      <div className="hidden fixed flex bottom-0 bg-transparent w-full h-12 z-10  p-2">
        <div className="items-center justify-start p-3 backdrop-blur-sm ring-1 ring-gray-800/40 rounded-md flex w-full h-full">
          <a className="font-light text-md" href="">
            MENU
          </a>
        </div>
      </div>
      ...
      <div
        id="preloader"
        className="fixed top-0 left-0 z-99 bg-black w-full h-full"
      >
        <div className="flex w-full h-full items-center justify-center">
          <div id="pretext" className="text-white transition">
            LOADING
          </div>
        </div>
      </div>
